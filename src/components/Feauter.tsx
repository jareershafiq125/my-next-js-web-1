  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="text-center mb-20">
        ...
        <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-slate-100">Explore the essential features of each Typescript project and easily run them using npx commands provided below:</p>
      </div>
      <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
        ...
        <div className="p-2 sm:w-1/2 w-full">
          <div className="bg-gray-100 rounded flex p-4 h-full items-center">
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" className="text-sky-500 w-6 h-6 flex-shrink-0 mr-4" viewBox="0 0 24 24">
              <path d="M22 11.08V12a10 10 0 11-5.93-9.14">npx run start:Number-guessing-game</path>
              <path d="M22 4L12 14.01l-3-3"></path>
            </svg>
            <span className="title-font font-medium">npx run start:</span>
          </div>
        </div>
      </div>
      <button className="flex mx-auto mt-16 text-white bg-sky-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">Visit My Github</button>
    </div>
  </section>
